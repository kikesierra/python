...
fichero = open('./datos/prueba.txt', 'rt')  # Modo de apertura 'rt' ==> r: read, t: texto
texto = fichero.read()  # Guarda el contenido del fichero en la variable texto de tipo str

print(texto)

# Grabar un fichero de texto
fichero = open('./datos/prueba2.txt', 'wt')  # Modo e apertura 'wt' ==> w: write, t: texto
...
fichero = open('./datos/prueba2.txt', 'at')  # Modo e apertura 'at' ==> a: append, t: texto
