...
# Permite capturar posibles errores de ejecución de un trozo de código y
# dar una respuesta controlada
# ----------------------------------------------------
...
except Exception:  # Otra excepción diferente a la división entre cero
